...
def deploy_igo_token_factory():
    ...
    igo_token_factory = FlattenedIgoToken.deploy(config['igo_token_params']['name'],config['igo_token_params']['symbol'], {"from": account}, publish_source=config["networks"][network.show_active()]["verify"])
